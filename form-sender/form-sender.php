    ...
    acf_add_local_field_group( [
        ...
        'fields'   => [
            ...
            [
                ...
                'key'   => '>attachments',
                'label' => 'Отправленные файлы',
                'name'  => 'attachments',
                'type'  => 'select',
                'required' => 0,
                'choices' => [
                    'send' => 'Прикреплять к письму',
                    'save' => 'Сохранять в папке на сайте',
                ],
                'wrapper' => [
                    'class' => 'field group-4',
                ],
...
function form_shortcode( $atts ){
    $form_id = $atts['id'];
    ob_start();
    include($_SERVER['DOCUMENT_ROOT']."/wp-content/plugins/form-sender/templates/form.php");
    return ob_get_clean();
}
